/*this function gets the task for the output*/
function get_todos() {
    /*this creates an array of tasks that are inputted*/
    var todos = new Array;
    /*this pulls the task that we saved in the web browser memory*/
    var todos_str = localStorage.getItem('todo');
    /* if the input is not a null then JSON.parse will
...
function add() {
    /*this takes the inputed task and makes it into a variable*/
...
/*this creates the functionality of removing a todo from the array*/
